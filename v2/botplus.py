...
class PostJob(ParallelJob):
    ...
    def __init__(self, channel: Channel, interval: int, short_text: bool=True) -> None:
    ...
    def do(self, bot: TelegramBot, call_time: int):
        ...
        post_body = bot.post_manager.create_post(self.account, self.channel.name, short_text=self.short_text)
